...
export default class CommonNumber extends Component {
  ...
  constructor (props) {
    super(props)
    let value = typeof (props.value) === 'number' ? (props.value) : (props.value || undefined)
    this.state = { value: value }
  }

  componentWillReceiveProps (nextProps) {
    if ('value' in nextProps) {
      let value = typeof (nextProps.value) === 'number' ? (nextProps.value) : (nextProps.value || undefined)
