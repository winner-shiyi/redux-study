...
export default class CommonSelect extends Component {
  ...
  componentWillReceiveProps (nextProps) {
    ...
    if ('value' in nextProps) {
      let value = typeof nextProps.value === 'number' ? nextProps.value
  ...
  onChange (value) {
    ...
    this.props.onSelect && this.props.onSelect(value, this.props.data.find((item) => {
      return item[this.props.valueName || 'id'] === value
    }))
  }
  ...
  search (value) {
    let action = this.props.action || this.props.state.action
