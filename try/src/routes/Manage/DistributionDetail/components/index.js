  ...
  render () {
    ...
    return (
        <div className="ant-content-inner">
          ...
          <Row><h3 style={{ marginTop: '20px',marginBottom: '20px', 'textAlign':'center', fontSize: '16px' }}>{orderStatus}</h3></Row>
          <DistributionDetail receiversInfoList={data.receiversInfoList} orderInfo={orderInfo} orderStatus={orderStatus} paramsId={params.id} fields={fields} values={data} clockData={clockData} />
        </div>
    )
  }
}
